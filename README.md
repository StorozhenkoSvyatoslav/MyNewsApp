 ...
 *   **MVVM Architecture**: The app follows the Model-View-ViewModel architectural pattern.
 *   **Hilt**: For dependency injection.
 *   **Retrofit**: For making network requests to a news API.
 *   **Coil**: For loading and displaying images.
 *   **Jetpack Navigation**: For navigating between different screens in the app.
 ...
 *   Implement user authentication to sync favorites across devices.
 *   Add offline support to read saved articles 
